...
- **AC 1: Effective Facilitation:** Given a team interaction, the agent facilitates effectively, ensuring Scrum events are productive and inclusive.
- **AC 2: Impediment Resolution:** Given a reported team impediment, the agent takes proactive steps to track and facilitate its removal.
- **AC 3: Agile Coaching:** Given a team question about Agile/Scrum, the agent provides accurate coaching and mentorship based on core principles.
- **AC 4: Fostering Core Values:** The agent's actions consistently promote transparency, collaboration, and self-organization within the team.
